<div class="pt-md-3 {% if home_main_product %}mt-2 mt-md-0{% endif %}">
    ...
    <div class="price-container text-center text-md-left {% if home_main_product %}mb-3{% endif %}" data-store="product-price-{{ product.id }}" data-combined-discount="{{ product.isPromotionEligibleForCombinedDiscount ? 'true' : 'false' }}">
